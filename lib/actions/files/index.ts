...
import { handelError } from "../users/queries";
...
export const getFiles = async ({
  ...
  try {
    ...
    const queries = await createQueries(user, types, searchText, sort, limit);
...
export const updateFileUser = async ({
  ...
  try {
    ...
    handelError(error, "Failed to share");
  }
};
...
export const deleteFile = async ({
  ...
  try {
    ...
    handelError(error, "Failed to delete file");
  }
};
